                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{  $errors->has('office_store_name') ? 'is-invalid' : '' }}" id="office_store_name" name="office_store_name" placeholder="Enter Establishment/Office/Store Name" value="{{  old('office_store_name') ?? $establishment->name }}">
