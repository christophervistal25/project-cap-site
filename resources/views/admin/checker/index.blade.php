...
<div class="card" >
    <div class="card-body">
      <div class="float-right">
        <a href="{{ route('checker.create') }}" class="btn btn-primary">ADD NEW CHECKER</a>
      </div>
          ...
          @foreach($checkers as $checker)
            <tr>
              ...
              <td class="text-center">
                <a class="btn btn-icon btn-sm btn-success text-white" href="{{ route('checker.edit', $checker->id) }} ">EDIT</a>
              </td>
            </tr>
          @endforeach
        </tbody>
